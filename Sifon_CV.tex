...
\hspace{-0.5cm}{\large Profesor Adjunto\\
\hspace{-0.65cm}        Instituto de F\'isica, Facultad de Ciencias\\
\hspace{-0.65cm}        \pucv\ (PUCV)\\
...
\technical{Collaborations}
{
 ...
 Emission-line Mapping of galaxy POpulations in the cosmicWeb Environmental Regimes (EMPOWER, \textit{proposal Co-I}) ---
...
\noindent
\itemdates{2026}{present} Profesor Adjunto (tenured), PUCV\\
\itemdates{2022}{2025} Profesor Auxiliar (tenured), PUCV\\
\itemdates{2019}{2022} Profesor Asociado (tenure track), PUCV\\
...
\itemdates{2010}{2012} M.Sc.~Astrophysics, Pontificia Universidad Cat\'olica de Chile (PUC), Chile\\
...
\noindent
% \itemdates{2025}{present} Gabriel Pichihueche, PUCV: MSc thesis advisor.\\
% \itemdates{2023}{2024} Javier Urrutia, PUCV: MSc thesis advisor.\\
% \itemdates{2020}{2022} Camila Aros, PUCV: MSc thesis advisor.\\
\itemdate{PUCV} 3 MSc theses advised (2 completed, 1 ongoing).\\
\itemdates{2017}{2019} Naomi Robertson, Oxford University (UK): co-advised PhD thesis project (Advisor: Jo Dunkley).\\
...
\noindent
% seminarios:
% 2024: G. Pichihueche, P.Verdejo, R. Rivera
% 2023 I. Moya
% 2022: P. Garrido
% 2021: L. Marmolejo
% verano:
...
\itemdate{PUCV} 6 Senior theses and 4 Summer projects.\\
\itemdate{Flatiron Institute: 2025} Simons Foundation--National Society of Black Physicists Mentoring Program.\\
\itemdate{Online: 2021} Central American-Caribbean Bridge in Astrophysics (\href{https://cencabridgeastro.weebly.com/our-team.html}{URL}). Semester research project.\\
\itemdate{Princeton: 2018 -- 2019} 1 Summer project and 1 Junior project.\\
...
\noindent
\itemdate{2026} ``An integral view of star formation: Gas, dust, star formation, and the growth of the intracluster medium over the past 7 Gyr'' (FONDECYT Regular, \textbf{PI}, 4 years, US\$200,000)\\
...
\itemdate{2023} ``A New High Redshift, High Mass SZ-Selected Cluster'' (\textit{Hubble Space Telescope} observing time grant, \textbf{Co-I}, US\$54,982)\\
...
\itemdate{2016} ``Measuring the Mass of El Gordo to Near the Virial Radius'' (\textit{Hubble Space Telescope} observing time grant, \textbf{Co-I}, US\$82,005)\\


\sectitle{Observing Proposals and Experience}
...
I have been the PI of more than 20 successful observing proposals in optical (VLT, Blanco, T80-South, Gemini, VST), near infrared (Magellan), and radio (GMRT, JVLA) telescopes.
%
% \noindent
% \itemdate{VLT/MUSE} 4h\\
% \itemdate{Blanco/DECam} 11 nights\\
% \itemdate{T80-South} 18 nights\\
% \itemdate{Magellan/FourStar} 2 proposals, 6 nights\\
% \itemdate{Very Large Array} 4.5 h\\
% \itemdate{Giant Metrewave Radio Telescope} 2 proposals, 44 h\\
% \itemdate{Gemini South/GMOS} 24 h\\
% \itemdate{VLT Survey Telescope/OmegaCAM} 6h\\
...
ALMA, Canadian Astronomical Society, \textit{Chandra} X-ray Observatory, NSF NOIRLab\\
\noindent
...
I was one of the lead developers of the galaxy-galaxy lensing pipeline used by the 
...
\sectitle{Other Relevant Work Experience}
...
% Tahoe, CA, USA. Certified as \emph{Level I Ski Instructor} by the 

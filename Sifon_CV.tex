...
\hspace{-0.5cm}{\large Profesor Asociado (\textit{Assistant Professor})\\
...
\noindent
\itemdates{2021}{present} Lya Marmolejo, PUCV: Undergraduate summer research project (USRP) and Senior thesis.\\
...
\noindent
\itemdate{2021A} Galactic Astronomy (Astronomy undergraduates, PUCV)\\
\itemdate{2020B} Cosmology, Programming (Physics+astronomy undergraduates, PUCV)\\
\itemdate{2020A} Observational Cosmology (Graduate-level astronomy, PUCV)\\
...
(Magellar/Fourstar), and radio (GMRT, VLA) telescopes.

...
% 
% \noindent
% I recently obtained my PhD from Leiden Observatory. The current focus of my 
% research is to study the masses of galaxies in galaxy groups and clusters using 
% weak gravitational lensing, with the aim of being able to test semi-analytic 
% models of galaxy formation and hydrodynamical simulations. I have also been 
% working on measuring galaxy cluster masses using the dynamics of their member 
% galaxies, aiming to calibrate the Sunyaev-Zel'dovich effect as a cluster mass 
% proxy. I am interested in the impact of intrinsic alignments on cosmic shear 
% studies and on the physics of galaxy clusters in general. I am an active member of 
% the Atacama Cosmology Telescope (ACT) and the Kilo-Degree Survey (KiDS).
...
% \pagebreak
% \noindent
% {\bf\Large Press Releases}\\
% \vspace{-0.2cm}
% 
% \begin{table}[h!]
% \begin{tabular}{l l}
% Jul., 2013 & Science Feature Result on 
% \href{http://issuu.com/geminifocus/docs/gf_0713?e=7451038/3860990}{GeminiFocus}, ``Dynamical 
% Masses 
% of Galaxy Clusters\\
%            & Discovered with the Sunyaev-Zel/dovic Effect.'' See Refereed Paper \#9.\\
% Mar., 2012 & Press release by
%   \href{http://www.princeton.edu/main/news/archive/S33/21/69O40/index.xml?section=topstories}{
%         Princeton University} on the first detection of the kinematic Sunyaev-\\
%            & Zel'dovich effect made with a combination of data from ACT and the Baryon\\
%            & Oscillations Spectroscopic Survey (BOSS). Also covered in a 
% \href{http://physics.aps.org/articles/v5/81}{Physics Viewpoint}. See\\
%            & Refereed Paper \#3.\\
% 
% Jan., 2012 & \href{http://www.eso.org/public/news/eso1203/}{ESO} and
%              \href{http://chandra.si.edu/photo/2012/elgordo/}{Chandra} release on ``El Gordo,'' 
% the
%              most massive known galaxy cluster at\\
%            & high redshift. See Refereed Paper \#1.
% \end{tabular}
% \end{table}

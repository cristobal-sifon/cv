...
\def\oja{The Open Journal of Astrophysics}
\def\pasj{PASJ}
\def\prd{Phys.\ Rev.\ D}
...
% arXiv links
\newcommand{\arxiv}[1]
    {\href{https://arxiv.org/abs/#1}{\texttt{\color{magenta}[#1]}}}

% highlight contributing papers
\newcommand{\highlight}{{\color{red} ${\bm \star}$}\,\,}

...
\noindent
I have co-authored 42 papers, including 6 first-author papers. They have been 
cited more than 1,200 times and have an $h$-index of 20, with more than 150 
...
\item E.~Medezinski, N.~Battaglia, K.~Umetsu, M.~Oguri, H.~Miyatake, A.~Nishizawa,
\myself, D.~N.~Spergel, I-N.~Chiu, Y.-T.~Lin, N.~Bahcall, Y.~Komiyama,
\textbf{``Planck Sunyaev-Zel’dovich Cluster Mass Calibration using Hyper Suprime-Cam Weak
Lensing''},
...
\textbf{``Source Selection for Cluster Weak Lensing Measurements in the Hyper Suprime-Cam
Survey''},
...
\textbf{``The First-Year Shear Catalog of the Subaru Hyper Suprime-Cam SSP Survey''},
